// Package randomwords provides a Go client for the Random Word API.
//
// For more information, visit: https://apiverve.com/marketplace/randomwords?utm_source=go&utm_medium=readme
package randomwords
...
const (
	baseURL        = "https://api.apiverve.com/v1/randomwords"
	defaultTimeout = 30 * time.Second
)

// Client is the Random Word API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Random Word API client.
...
// Execute makes a request to the Random Word API.
